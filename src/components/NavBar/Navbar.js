            ...
            <div className='container-lg'>
                <NavLink className='navbar-brand mr-5' to="/">
                    <motion.div className='nav-text' whileHover={{ scale: 1.1 }}>
                        <img src={ process.env.PUBLIC_URL + '/logo2.svg'} height="50" width="50" alt="logo" className='nav-img' />                   
                        SpotiStats
                    </motion.div>             
                </NavLink>
                <button className='navbar-toggler' type='button' data-toggle='collapse' data-target='#collapseToggle' aria-controls='collapseToggle' aria-expanded='false' aria-label='Toggle nav'>
                    <span className='navbar-toggler-icon' style={{backgroundImage: `url(${process.env.PUBLIC_URL}/menu.png)`}}></span>
                </button>
